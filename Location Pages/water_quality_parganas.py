...
def fetch_weather_forecast(location, start_date):
    location_coords = {
        'DIAMOND HARBOUR, WEST BENGAL': {'lat': 22.1848,'lon': 88.1891}
    }
...
def main():
    ...
    # Title with Gradient
    st.markdown('<h1 class="gradient-text">GANGA AT DIAMOND HARBOUR, 24 PARGANAS(S)WEST BENGAL </h1>', unsafe_allow_html=True)

    # Hardcoded Location
    selected_location = "DIAMOND HARBOUR, WEST BENGAL"
