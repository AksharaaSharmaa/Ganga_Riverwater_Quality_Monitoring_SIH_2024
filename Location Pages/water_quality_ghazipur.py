...
LOCATIONS = {
    'GANGA AT TRIGHAT (GHAZIPUR), U.P': {
        'file_path': r"C:\Users\New User\OneDrive\Desktop\SIH1694_19975_AquaVisionAI\New Dataset\Ghazipur.csv",
        'lat': 25.578175,
        'lon': 83.609594
    }  
}
...
def main():
    ...
    # Title with Gradient
    st.markdown('<h1 class="gradient-text">GANGA AT TRIGHAT (GHAZIPUR), U.P</h1>', unsafe_allow_html=True)
