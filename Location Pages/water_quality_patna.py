...
LOCATIONS = {
    'GANGA AT GULABI GHAT, PATNA': {
        'file_path': r"C:\Users\New User\OneDrive\Desktop\SIH1694_19975_AquaVisionAI\New Dataset\Patna.csv",
        'lat': 25.620356,
        'lon': 85.179995
    }  
}
...
def main():
    ...
    # Title with Gradient
    st.markdown('<h1 class="gradient-text">GANGA AT GULABI GHAT, PATNA</h1>', unsafe_allow_html=True)

    # Hardcoded Location
    selected_location = "GANGA AT GULABI GHAT, PATNA"
