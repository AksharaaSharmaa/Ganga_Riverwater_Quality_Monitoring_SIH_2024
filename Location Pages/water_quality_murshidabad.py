...
def fetch_weather_forecast(location, start_date):
    location_coords = {
        'MURSHIDABAD, WEST BENGAL': {'lat': 24.0988,'lon': 88.2679}
    }
...
def main():
    ...
    # Title with Gradient
    st.markdown('<h1 class="gradient-text">GANGA AT BAHARAMPORE, MURSHIDABAD, WEST BENGAL</h1>', unsafe_allow_html=True)

    # Hardcoded Location
    selected_location = "MURSHIDABAD, WEST BENGAL"
