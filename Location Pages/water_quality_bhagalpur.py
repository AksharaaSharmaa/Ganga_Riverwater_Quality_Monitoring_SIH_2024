...
# Locations dictionary remains unchanged
LOCATIONS = {
    'GANGA AT U/S BHAGALPUR NEAR BARARIGHAT': {
        'file_path': r"C:\Users\New User\OneDrive\Desktop\SIH1694_19975_AquaVisionAI\New Dataset\Bhagalpur.csv",
        'lat': 25.271603,
        'lon': 87.025665
    }  
}
...
def main():
    ...
    # Title with Gradient
    st.markdown('<h1 class="gradient-text">GANGA AT U/S BHAGALPUR NEAR BARARIGHAT</h1>', unsafe_allow_html=True)
