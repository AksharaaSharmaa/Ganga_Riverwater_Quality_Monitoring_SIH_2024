...
def main():
    ...
    # Title with Gradient
    st.markdown('<h1 class="gradient-text">ALAKNANDA A/C WITH BHAGIRATHI AT DEVPRAYAG</h1>', unsafe_allow_html=True)

    # Hardcoded Location
    selected_location = "ALAKNANDA A/C WITH BHAGIRATHI AT DEVPRAYAG"
