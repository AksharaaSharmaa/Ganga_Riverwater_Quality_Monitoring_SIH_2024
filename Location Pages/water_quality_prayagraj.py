...
LOCATIONS = {
    'GANGA AT ALLAHABAD D/S (SANGAM), U.P': {
        'file_path': r"C:\Users\New User\OneDrive\Desktop\SIH1694_19975_AquaVisionAI\Ganga_Project\Datasets\Prayagraj.csv",
        'lat': 25.419206,
        'lon': 81.900522
    }  
}
...
def main():
    ...
    # Title with Gradient
    st.markdown('<h1 class="gradient-text">GANGA AT ALLAHABAD D/S (SANGAM), U.P</h1>', unsafe_allow_html=True)

    # Hardcoded Location
    selected_location = "GANGA AT ALLAHABAD D/S (SANGAM), U.P"
    ...
    if selected_location:
        ...
        parameters = [
            ...
            if param not in ['Date', 'Temperature', 'Rainfall', 'WQI', 'Quality']
        ]
