...
LOCATIONS = {
    'NAINI': {
        'file_path': r"C:\Users\New User\OneDrive\Desktop\SIH1694_19975_AquaVisionAI\Naini.csv",
        'lat': 25.3871,
        'lon': 81.8597
    }  
}
...
def display_water_quality_alerts(forecast_values, parameter_data):
    ...
    if not risk_parameters:
        ...
        st.success("✅ Water Quality: All parameters are within limits.")
    else:
